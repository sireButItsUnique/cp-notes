...
binary search can narrow a continuous range (e.g., [0.0, 1.0]) until a satisfactory error margin is achieved.<br/>
**Slope**: If there is a single local min/max which you want to find, test both sides of the mid point to see which way the slope is going.
Examples include [ccc21s3](/exemplars/ccc21s3) and [oly19practice60](/exemplars/oly20practice130) <br/>
